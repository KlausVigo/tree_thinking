function(){
    tabPanel("About",
HTML("<h1>Tree Thinking</h1>
    <p>tree_thinking provides some small quizzes to test your knowledge about phylogenetic trees inspired by the book 'Tree thinking'.</p>
    ...
    <a ref='https://klash.shinyapps.io/tree_thinking/'>https://klash.shinyapps.io/tree_thinking/</a> from your web browser.</p>
